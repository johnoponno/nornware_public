	...
	win32_d3d9_softdraw_adapter_t& in_adapter)
{
...

	{
		...
		::IDirect3DStateBlock9* sb = __state_block_begin(in_mode, ::D3DCULL_CCW, D3DFVF_XYZRHW | D3DFVF_DIFFUSE | D3DFVF_TEX1, in_filter, in_adapter.texture);

...
struct w32_d3d9_enum_device_settings_combo_t;

//--------------------------------------------------------------------------------------
// A struct describing a Direct3D device that contains a 
//       unique supported device type 
//--------------------------------------------------------------------------------------
struct w32_d3d9_enum_device_info_t
{
	~w32_d3d9_enum_device_info_t();

	::D3DDEVTYPE device_type;
	::D3DCAPS9 caps;
	std::vector<w32_d3d9_enum_device_settings_combo_t*> device_settings_combo_list;		// List of CD3DEnumDeviceSettingsCombo* with a unique set of AdapterFormat, BackBufferFormat, and Windowed
};
...
//--------------------------------------------------------------------------------------
struct w32_d3d9_enum_adapter_info_t
{
	~w32_d3d9_enum_adapter_info_t();
	...
	std::vector<w32_d3d9_enum_device_info_t*> device_info_list; // Array of CD3DEnumDeviceInfo* with unique supported DeviceTypes
};
...
struct w32_d3d9_enum_device_settings_combo_t
{
	...
	std::vector<w32_d3d9_enum_depth_stencil_multisample_conflict_t> dsms_conflicts; // List of CD3DEnumDSMSConflict

	w32_d3d9_enum_adapter_info_t* adapter_info;
	w32_d3d9_enum_device_info_t* device_info;
};
...
//--------------------------------------------------------------------------------------
struct w32_d3d9_enumeration_t
{
	static w32_d3d9_enumeration_t* instance();
	~w32_d3d9_enumeration_t();

	std::vector<w32_d3d9_enum_adapter_info_t*> adapter_info_list;
...
private:
	...
	// Use DXUTGetEnumeration() to access global instance
	explicit w32_d3d9_enumeration_t();
};

...
#define NINJA_VC_SCREEN_HEIGHT 208	//13 tiles

#define NINJA_VC_SOFT_BUTTON_HEIGHT 16
#define NINJA_VC_SOFT_Y_SPACE 8

#define NINJA_VC_GUI_INSIDE 1
#define NINJA_VC_GUI_LEFT 2
#define NINJA_VC_GUI_RIGHT 4
...
static_assert(M_WORLD_WIDTH / NINJA_VC_TILES_ON_SCREEN_X == NINJA_VC_SCREENS_IN_WORLD_X, "wtf!?");
static_assert(M_WORLD_HEIGHT / NINJA_VC_TILES_ON_SCREEN_Y == NINJA_VC_SCREENS_IN_WORLD_Y, "wtf!?");

...
namespace m25
{
	...
	{
		if (NINJA_VC_GUI_LEFT & vc_gui_big_text(in_micron, in_micron.canvas_width / 2, MENU_Y + NINJA_VC_OCTAFONT_HEIGHT * 2, -1, "Credits", out_fatpack))
			out_fatpack.idle_screen = VC_SCREEN_CREDITS;

		if (NINJA_VC_GUI_LEFT & vc_gui_big_text(in_micron, in_micron.canvas_width / 2, MENU_Y + NINJA_VC_OCTAFONT_HEIGHT * 4, -1, "Exit", out_fatpack))
			return false;
		...
		vc_fatpack_t& out_fatpack)
	{
		...
		if (NINJA_VC_GUI_LEFT & vc_gui_big_text(in_micron, in_micron.canvas_width / 2, in_micron.canvas_height - NINJA_VC_OCTAFONT_HEIGHT / 2, -1, "Back", out_fatpack))

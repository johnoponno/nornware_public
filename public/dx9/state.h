...
namespace dx9
{
	...
	struct state_t
	{
		...
		enumeration_t* m_d3d_enumeration;          // CD3DEnumeration object
		device_settings_t* m_device_settings;   // current device settings
		...
		backbuffer_size_t fullscreen_backbuffer_at_mode_change;
		backbuffer_size_t windowed_backbuffer_at_mode_change;
	...
	extern float get_backbuffer_aspect_ratio();
	extern ::HWND hwnd();
	extern bool is_windowed();
	extern void toggle_wireframe();
	extern bool is_wireframe();
	extern bool is_rendering_paused();
